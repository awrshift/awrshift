...
# Usage: curl -sL https://raw.githubusercontent.com/awrshift/awrshift/main/install.sh | bash
#
...
git clone --quiet --depth 1 https://github.com/awrshift/awrshift.git .awrshift-tmp 2>/dev/null
